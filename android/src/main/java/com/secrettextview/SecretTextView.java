...
import com.secrettextview.MutableForegroundColorSpan;
...
public class SecretTextView extends TextView {
    ...
    private com.secrettextview.MutableForegroundColorSpan[] mSpans;
    ...
    private void resetIfNeeded(){
        if (!mIsTextResetting){
            ...
            for (int i = 0; i < this.mTextString.length(); i++) {
                MutableForegroundColorSpan span = new com.secrettextview.MutableForegroundColorSpan();
                mSpannableString.setSpan(span, i, i+1, Spanned.SPAN_EXCLUSIVE_INCLUSIVE);
                mSpans[i] = span;
            }
    ...
    public void setFontColor(String colorHexString){
        this.setTextColor(this.hex2Rgb(colorHexString));
    }
